...
RECOMP_IMPORT(".", u8 NetworkSyncRegisterActor(const char *actor_id));
RECOMP_IMPORT(".", u8 NetworkSyncGetClientId(char *buffer, u32 bufferSize));
RECOMP_IMPORT(".", void NetworkSyncSendActorUpdate(const char *actor_id, void *data));
...
RECOMP_IMPORT(".", u8 NetworkSyncGenerateUUID(char *buffer));
